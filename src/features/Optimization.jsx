  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        <div className="rounded-[var(--radius-card)] border border-secondary-500/12 bg-surface-50/80 p-5 shadow-soft dark:border-surface-50/10 dark:bg-surface-900/70">
          ...
          {isOptimizing ? (
            <div className="space-y-4">
              {[...Array(3)].map((_, index) => (
                <div
                  key={index}
                  className="h-40 animate-pulse rounded-[var(--radius-card)] border border-secondary-500/10 bg-surface-50/70 dark:border-surface-50/10 dark:bg-surface-900/70"
                />
              ))}
            </div>
