    ...
    <div className="w-full overflow-x-hidden bg-black text-white selection:bg-emerald-500/30 selection:text-emerald-200">
      ...
      <section className="relative z-10 min-h-[75vh] flex flex-col justify-center items-center px-4 py-20 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center space-y-8 md:space-y-12">
          ...
          {/* Trust Badge */}
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/5 backdrop-blur-md border border-white/10 text-emerald-300 text-sm font-medium animate-fade-in hover:bg-white/10 transition-colors cursor-default shadow-lg shadow-emerald-900/20 ring-1 ring-emerald-500/20">
            <Star className="w-4 h-4 fill-emerald-300/20 text-emerald-300" />
            <span>{t("landing.trustBadge")}</span>
          </div>

          {/* Main Headline */}
          <div className="space-y-6">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[0.9] text-white">
              {t("landing.hero.title")}
              <span className="block mt-2 bg-gradient-to-r from-emerald-400 via-teal-200 to-cyan-400 bg-clip-text text-transparent pb-4 min-h-[1.2em]">
                {dynamicText}
                <span className="animate-blink text-white opacity-50 font-light">|</span>
              </span>
            </h1>

            <p className="max-w-2xl mx-auto text-lg sm:text-xl md:text-2xl text-white/60 leading-relaxed font-light"
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            ...
            <button
              ...
              className="w-full sm:w-auto h-14 sm:h-16 px-8 text-lg rounded-full bg-white/5 hover:bg-white/10 text-white border border-white/10 backdrop-blur-sm transition-all duration-300 hover:scale-105"
            >
          ...
          {/* Social Proof */}
          <div className="pt-12 flex flex-wrap justify-center gap-x-8 gap-y-4 text-white/40 text-sm font-medium">
      ...
      <section id="demo-section" className="relative z-10 py-24 md:py-32 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-5xl font-bold bg-gradient-to-br from-white to-white/50 bg-clip-text text-transparent">
      ...
      <section className="relative z-10 py-24 md:py-32 px-4 bg-gradient-to-b from-black to-emerald-950/20">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 text-center lg:text-left">
              ...
              <h2 className="text-3xl md:text-5xl font-bold leading-tight">
                <span className="text-white">{t("vision2030.landing.title").split("Vision")[0]}</span>
                <span className="text-[#4ade80] drop-shadow-[0_0_15px_rgba(74,222,128,0.3)]"> Vision 2030</span>
              </h2>
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-4 relative">
                {VISION_2030_SECTORS.slice(0, 4).map((sector, idx) => (
                  <div
                    key={sector.id}
                    className="group p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-[#006C35]/20 hover:border-[#006C35]/50 hover:scale-[1.02] transition-all duration-300 backdrop-blur-md"
                  >
                    <div className="w-12 h-12 mb-4 rounded-xl bg-[#006C35]/20 flex items-center justify-center group-hover:bg-[#006C35] transition-colors">
                      <SectorIcon sectorId={sector.id} className="w-6 h-6 text-[#4ade80] group-hover:text-white" />
                    </div>
      ...
      <section className="relative z-10 py-24 md:py-32 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-emerald-200 via-white to-emerald-200 bg-clip-text text-transparent mb-6">
          ...
          <div className="relative grid md:grid-cols-3 gap-12">
            ...
            {steps.map((step, idx) => (
              <div key={idx} className="relative group text-center space-y-6">
                <div className="relative mx-auto w-24 h-24 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/10 flex items-center justify-center group-hover:scale-110 group-hover:border-emerald-500/30 transition-all duration-500 shadow-[0_0_30px_-10px_rgba(0,0,0,0.5)]">
                  ...
                  <step.icon className="w-10 h-10 text-emerald-300 group-hover:text-emerald-400 transition-colors" />
                </div>
