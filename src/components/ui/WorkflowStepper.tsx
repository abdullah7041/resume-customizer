            ...
            <li key={step.id} className="flex min-w-0 flex-1 items-center">
              <button
                ...
                className={cn(
                  ...
                  isActive &&
                    'border-emerald-500/50 bg-emerald-500/10 shadow-[var(--shadow-soft)]',
                  isCompleted &&
              ...
              >
                ...
                <span className="flex min-w-0 flex-col leading-tight">
                  ...
                  {step.hint && (
                    <span className="hidden truncate text-[11px] text-gray-500 dark:text-emerald-100/55 sm:block">
                      {step.hint}
                    </span>
                  )}
                </span>
