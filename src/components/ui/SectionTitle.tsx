...
export default function SectionTitle({ eyebrow, title, description, className }) {
  return (
    ...
    >
      {eyebrow && (
        <p className="inline-flex items-center gap-2 flex-row rtl:flex-row-reverse rounded-pill border border-[color:var(--glass-border)] bg-[color:color-mix(in_oklab,var(--surface-glass),transparent_35%)] px-4 py-1 text-xs font-semibold uppercase tracking-[0.32em] text-gold-500 shadow-soft">
