  ...
  return (
    <button
      className={cn(
        ...
        "border border-[color:color-mix(in_oklab,var(--accent),var(--surface)_78%)] text-[color:var(--surface)] shadow-[0_28px_80px_-46px_color-mix(in_oklab,var(--emerald-900),transparent_55%)]",
        "bg-[radial-gradient(circle_at_18%_-18%,color-mix(in_oklab,var(--surface-strong),transparent_46%)_0%,transparent_52%),var(--gradient-primary)]",
        ...
        "after:pointer-events-none after:absolute after:inset-[2px] after:rounded-[calc(var(--radius-card)_/_1.9)] after:border after:border-[color:color-mix(in_oklab,var(--panel-stroke),transparent_38%)] after:opacity-80 after:content-['']",
        "disabled:translate-y-0 disabled:cursor-not-allowed disabled:border-[color:color-mix(in_oklab,var(--accent),var(--surface)_88%)] disabled:bg-[color-mix(in_oklab,var(--accent),var(--surface)_72%)] disabled:text-[color:color-mix(in_oklab,var(--surface),transparent_38%)] disabled:shadow-none disabled:before:hidden disabled:after:hidden",
        className
      )}
