  ...
  return (
    <button
      className={cn(
        ...
        "focus-visible:ring-accent-100 focus-visible:ring-offset-sand-50",
        "before:pointer-events-none before:absolute before:inset-[1px] before:-translate-x-full before:rounded-[calc(var(--radius-card)_/_1.8)] before:bg-[linear-gradient(120deg,rgba(255,255,255,0)_0%,rgba(255,255,255,0.55)_45%,rgba(255,255,255,0)_100%)] before:opacity-0 before:transition before:duration-500 before:ease-out before:content-[''] hover:before:translate-x-0 hover:before:opacity-100",
