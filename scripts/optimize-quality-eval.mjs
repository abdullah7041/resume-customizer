...
- PRESERVE REAL EVIDENCE: when the resume already states a concrete metric, scope, technology, or scale, keep it VERBATIM and specific in the rewrite. Do not generalize, round down, or soften real numbers. This protocol exists to stop INVENTED facts — it must never make you strip or vague-ify facts the resume actually contains. A resume rich in real metrics should stay rich.
